# Tous les projets publics de logiciels et applications mobiles fonctionnels de DeveloppeurPascal en un seul dépôt

[This page in english.](README.md)

Installe tous mes projets publics de logiciels et applications mobiles sous la forme de sous dossiers de celui-ci.

Ce dépôt de code simplifie le téléchargement de certains dépôts [du compte GitHub DeveloppeurPascal](https://github.com/DeveloppeurPascal) et leurs dépendances.
...
[Ce dépôt de code](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack) et tous ses sous-projets sont disponibles sur [mon compte GitHub](https://github.com/DeveloppeurPascal).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack/issues).
