# All public DeveloppeurPascal working programs and mobile aplications in one code repository

[Cette page en français.](LISEZMOI.md)

Install my public working programs repositories as sub folders of current project.

This code repository simplify downloading a selection of repositories from [DeveloppeurPascal GitHub account](https://github.com/DeveloppeurPascal) and their dependencies.
...
[This repository](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack) and all projects are available on [my GitHub account](https://github.com/DeveloppeurPascal).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack) and [open a new issue](https://github.com/DeveloppeurPascal/DevPas-WorkingPrograms-Pack/issues).
